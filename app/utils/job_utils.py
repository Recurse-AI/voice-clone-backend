...
class JobUtils:
    ...
    @staticmethod
    def prepare_manifest_for_redub(manifest: Dict[str, Any], redub_job_id: str, target_language: str, parent_job_id: str, voice_premium_model: bool = False, voice_type: str = None, reference_id: str = None) -> Dict[str, Any]:
        """
        ...
        if reference_id is not None:
            updated_manifest["reference_id"] = reference_id
