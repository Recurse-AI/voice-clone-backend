...
class BaseFlow:
    """Base class for all dubbing flows with common operations"""
    
    @staticmethod
    def handle_review_mode(context: DubbingContext) -> Dict[str, Any]:
        """Handle review mode preparation with optional reference_id assignment"""
    ...
    def execute_voice_cloning_and_finalize(context: DubbingContext) -> Dict[str, Any]:
        """Execute voice cloning and finalization steps"""
